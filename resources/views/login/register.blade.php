        ...
        <div class="registerCon">
            <ul>
                <li class="accAndPwd">
                    ...
                    <dl>
                        <s class="password"></s>
                        <input type="text" class="pwd" maxlength="11"  placeholder="6-16位数字、字母组成" value="" >
                    ...
                    <dl>
                        ...
                        <button id="code" class="layui-btn layui-btn-xs">获取验证码</button>
                    </dl>
                    <dl class="a-set">
                ...
                <a id="btnNext" href="javascript:;" class="orangeBtn loginBtn" ><font>注册</font>  </a>
        </div>
    ...
    layui.use('layer',function(){
        ...
        $('#btnNext').click(function(){
            ...
            $.ajax({
                method: "POST",
                url: "registeradd",
                data: {user_tel:user_tel,user_pwd:user_pwd,repwd:repwd,code:code,_token:"{{csrf_token()}}"}
            }).done(function(res) {
                // layer.msg(res);
                    if(res=="ok"){
